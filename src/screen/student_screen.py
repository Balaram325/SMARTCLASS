...
def student_dashboard():
    ...
    with c2:
        ...
        if st.button("Logout", type='secondary', key='loginbackbtn', shortcut="control+enter"):
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder="E.g. Balaram Mandal")
            ...
            audio_data = None
            try:
                audio_data = st.audio_input("Record a short phrase like I am present, My name is Raju.")
            except Exception:
                        ...
                        if encodings:
                            ...
                            if audio_data:
                                ...
                                if voice_emb is None:
                                    st.error("Could not process voice recording. Please record again.")
                                    st.stop()
